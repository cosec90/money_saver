      ...
      <div class="col-md-10 right-main">
        <div class="upper-div">
          ...
          <div class="main-form-input">
            <form action="../Admin-modules/expense_add.php" method="post">
                <div class="form-group">
                  <label for="email">Enter date of expenditure</label>
                  <input type="date" class="form-control" name="date_expense" required>
                </div>
                <div class="form-group">
                  <label for="email">Enter money spent</label>
                  <input type="text" class="form-control" name="money_spent" required>
                </div>
                <button type="submit" class="btn submit-pocket" name="expense-sub">Enter expenditure</button>
            </form>
          </div>
      </div>
    </div>
